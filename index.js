...
class Student extends Lambdasian{
  ...
  listSubjects(){
    const allFavs = this.favSubjects.join(", ");
    return `Loving ${allFavs}!`;
  }
  ...
  graduate(){
    if (this.grade > 70){
      return "Congrats, you're ready to graduate from Lambda School!"
    }
  }
}
...
/*
  STRETCH PROBLEM (no tests!)
    ...
    - Now that our students have a grade build out a method on the Instructor (this will be used by _BOTH_ instructors
      nd PM's) that will randomly add or subtract points to a student's grade. _Math.random_ will help.
